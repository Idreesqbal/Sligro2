{%- set yaml_metadata -%}
source_model:
    base_stg_slim4__cdc_forecast
derived_columns:
    RECORD_SOURCE: "!slim4__cdc_forecast"
    ...
    CUSTOMER_BK: "CAST(NULL AS STRING)"
    SITE_BK: "CAST(store_number AS STRING)"
    SUPPLIER_BK: "CAST(CAST(SPLIT(supplier_number, '_')[SAFE_OFFSET(0)] AS INTEGER) AS STRING)"
    EMPLOYEE_BK: "CAST(CAST(SPLIT(supplier_number, '_')[SAFE_OFFSET(1)] AS INTEGER) AS STRING)"
