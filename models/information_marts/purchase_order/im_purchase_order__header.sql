...
final AS (
    SELECT
        bv_hub__purchase_order.purchase_order_bk AS pk_purchase_order_code,
        ...
        hub_site.site_bk AS fk_ship_to_site_code,
        ...
        bv__purchase_order.znkdba AS communication_method_description
...
SELECT
    pk_purchase_order_code,
    fk_supplier_code,
    fk_ship_to_site_code,
    fk_promotion_code,
    'Missing' AS fk_cost_centre_code,
    'Missing' AS fk_currency_code, -- This is always euro
    fk_requester_code,
    purchase_order_code,
    purchase_order_type,
