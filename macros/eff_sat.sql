-- This macro overrides the eff_sat macro of automate-dv,
-- and implements multiple sources for eff_sats. It can be
-- removed once this PR has been merged, a new version was
-- released and we updated the dep:
-- https://github.com/Datavault-UK/automate-dv/pull/252
